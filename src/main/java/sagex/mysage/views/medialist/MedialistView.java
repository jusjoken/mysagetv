package sagex.mysage.views.medialist;
...
import sagex.mysage.views.MainLayout;
 ...
 */
@PageTitle("Medialist")
@Route(value = "medialist", layout = MainLayout.class)
@Tag("medialist-view")
@JsModule("./views/medialist/medialist-view.ts")
public class MedialistView extends LitTemplate implements AfterNavigationObserver {
